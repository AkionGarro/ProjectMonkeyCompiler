...
public class MonkeyGrammarLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LET", "RETURN", "GreaterT", "LowerT", "GreaterEQ", "LowerEQ", "Equeals", 
			"BLOCK_OPEN", "BLOCK_CLOSE", "BRACKET_OPEN", "BRACKET_CLOSE", "PAR_OPEN", 
			"PAR_CLOSE", "LETTER", "DIGIT", "CHARIN", "QUOTE", "NotEqueals", "Sum", 
			"Res", "Mul", "Div", "Mod", "DivEnt", "Open", "Close", "Comment", "Len", 
			"First", "Last", "Rest", "Push", "Boolean", "WS", "COMMA", "SEMICOLON", 
			"TRUE", "FALSE", "IF", "ELSE"
		};
	}
	...
	public MonkeyGrammarLexer(CharStream input) {
		super(input);
